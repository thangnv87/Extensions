...
- Marketplace dùng endpoint Unified ổn định trên `https://podhub.space` để server xử lý đồng thời Spy, license entitlement và tạo job.
...
- Extension chỉ gọi gateway `https://podhub.space/api/bridge/v1` bằng access token của license.
...
The extension expects GPT links and optional module endpoint overrides from `https://podhub.space`.
